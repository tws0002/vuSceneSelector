...
class Header(QtGui.QWidget):
	def __init__(self, window):
		...
		labelShotInfo = QtGui.QLabel("Description:")


		# Name
		self.descrLabelName = QtGui.QLabel("ShotName:")
		self.descrValueName = QtGui.QLabel()
		self.descrValueNameSchnitt = QtGui.QLabel()
		self.descrValueNameSchnitt.setStyleSheet(style.styleTextGrey)
		...
		# FPS
		self.descrLabelFPS = QtGui.QLabel("FPS:")
		self.descrValueFPS = QtGui.QLabel()

		# Lens
		self.descrLabelLens = QtGui.QLabel("Lens:")
		self.descrValueLens = QtGui.QLabel()

		vbox = QtGui.QVBoxLayout()
		self.grpInfo.setLayout(vbox)


		# ShotName
		hbox = QtGui.QHBoxLayout()
		hbox.addWidget(self.descrLabelName)
		hbox.addItem(QtGui.QSpacerItem(0, 0, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum))
		hbox.addWidget(self.descrValueNameSchnitt)
		hbox.addWidget(self.descrValueName)
		vbox.addLayout(hbox)
		...
		# FPS
		hbox = QtGui.QHBoxLayout()
		hbox.addWidget(self.descrLabelFPS)
		hbox.addItem(QtGui.QSpacerItem(0, 0, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum))
		hbox.addWidget(self.descrValueFPS)
		vbox.addLayout(hbox)

		# Lens
		hbox = QtGui.QHBoxLayout()
		hbox.addWidget(self.descrLabelLens)
		hbox.addItem(QtGui.QSpacerItem(0, 0, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum))
		hbox.addWidget(self.descrValueLens)
		vbox.addLayout(hbox)
	...
	def setText_Shots(self, selName):
		...
		# ShotName
		self.descrValueName.setText(selName)
		...
		self.descrValueFrameHandleStart.setText("(" + str(1026 - starthandleInt) + ")")
		self.descrValueFrameRange.setText("1026 - " + endFrame)
		self.descrValueFrameHandleEnd.setText("(" + str(endFrameInt + endhandleInt) + ")")

		# FPS & Lens
		self.descrValueFPS.setText(Index.getValue(selName, "FPS") + " FPS")
		self.descrValueLens.setText(Index.getValue(selName, "Lens"))
