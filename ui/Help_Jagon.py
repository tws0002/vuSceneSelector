...
url_root = "https://www.filmakademie.de/wiki/display/AISPD/vuSceneSelector"
URL_SCENESELECTOR_STEPBYSTEP = url_root + "#vusceneselector-stepbystep"
URL_SCENESELECTOR_TIPPS = url_root + "#vusceneselector-tipps"
URL_SCENESELECTOR_DOCU = url_root + "#vusceneselector-docu"
URL_SCENESELECTOR_FAQ = url_root + "#vusceneselector-faq"
...
class HelpPage(QtGui.QDialog):
	def __init__(self, widget=None):
		...
		self.setWindowIcon(QtGui.QIcon(project.GRAPHICS + "/appIconHelp.png"))
	...
	def show_PopupImage(self, path):
		...
		popup.setWindowIcon(QtGui.QIcon(project.GRAPHICS + "/appIconHelp.png"))
